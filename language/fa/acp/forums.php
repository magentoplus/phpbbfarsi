...
$lang = array_merge($lang, array(
	...
	'LINK'						=> 'لینک',
	'LIST_INDEX'				=> 'لیست کردن انجمن در فهرست انجمن مادر',
	'LIST_INDEX_EXPLAIN'		=> 'با فعال کرن این گزینه این انجمن در صفحه اصلی شما نمایش داده خواهد شد.',
	'LIST_SUBFORUMS'			=> 'لیست کردن زیر انجمن ها در فهرست انجمن مادر',
	'LIST_SUBFORUMS_EXPLAIN'	=> 'با فعال کردن این گزینه زیر انجمن های این انجمن نیز در صفحه اصلی به نمایش در خواهند آمد.',
	'LOCKED'					=> 'قفل شده',
